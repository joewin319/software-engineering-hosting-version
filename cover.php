...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="60px" height="60px"><strong> Mediviron </strong>Appointment Booking System</a></li>
			...
			<div class="footer">
				<ul style="position:absolute;top:93%;background-color:black">
					<li><a href="http://alphadevx.infinityfreeapp.com/Admin/alogin.php">Admin Login</a></li>
					<li><a href="http://alphadevx.infinityfreeapp.com/Admin/mlogin.php">Manager Login</a></li>
				</ul>
			</div>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="http://alphadevx.infinityfreeapp.com/signup.php" method="post">
    <div class="imgcontainer">
...
else
{
	...
	if ($num == 1) {
		...
		header( "Refresh:1; url=http://alphadevx.infinityfreeapp.com/ulogin.php"); 
	} 
	else 
	{
		$error = "Username or Password is invalid";
