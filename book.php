...
function getDay(val) {
	...
	$.ajax({
	type: "POST",
	url: "http://alphadevx.infinityfreeapp.com/getDay.php",
...
<body style="background-image:url(images/bookback.jpg)">
	<div class="header">
		<ul>
			...
			<li><a href="http://alphadevx.infinityfreeapp.com/book.php">Book Now</a></li>
	...
	<div class="sucontainer" style="background-image:url(images/bookback.jpg)">
		...
		<label style="font-size:20px; color:black;" ><b>City:<b></label><br>
		...
		<label style="font-size:20px; color:black;" ><b>Town:<b></label><br>
		<select id="town-list" name="Town" onChange="getClinic(this.value);" style="width:100%;height:35px;border-radius:9px">
		<option value="">Select Town</option>
		</select><br>
		
		<label style="font-size:20px; color:black;" ><b>Clinic:<b></label><br>
		<select id="clinic-list" name="Clinic" onChange="getDoctorday(this.value);" style="width:100%;height:35px;border-radius:9px">
		<option value="">Select Clinic</option>
		</select><br>
		
		<label style="font-size:20px; color:black;" ><b>Doctor:<b></label><br>
		<select id="doctor-list" name="Doctor" onChange="getDate(this.value);" style="width:100%;height:35px;border-radius:9px">
		<option value="">Select Doctor</option>
		</select><br>
		
		
		<label style="font-size:20px; color:black;"><b>Date of Visit:</b></label><br>
		<input type="date" name="dov" onChange="getDay(this.value);" min="<?php echo date('Y-m-d');?>" max="<?php echo date('Y-m-d',strtotime('+14 day'));?>" required><br><br>
		
		<label style="font-size:20px; color:black;"><b>Time of Visit:</b></label><br>
		<input type="time" name="timeappt" required>
...
if(isset($_POST['submit']))
{
		...
		$sql = "INSERT INTO book (Username,Fname,Gender,CID,DID,DOV,Timestamp,Status,time) VALUES ('$username','$fname','$gender','$cid','$did','$dov','$timestamp','$status','$time') ";
