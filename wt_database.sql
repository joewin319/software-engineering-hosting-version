...
(1, 'Mediviron Clinic Cyberjaya', 'Shaftsbury Square 2350, Cyb', 'Cyberjaya', 'Selangor', 383221709, '1');
...
(1, 'Jaden', 'male', '1980-01-01', 10, 'Orthodontist', 9, 'KWS tower, Cyb', 'doctor', 'doctor', 'Selangor');
...
(1, 'Manager', 'male', '1990-01-01', 126232220, 'XYZ complex CST', 'manager', 'manager', 'Cyberjaya');
