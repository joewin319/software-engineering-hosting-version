...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="cal.png" width="60px" height="60px"><strong> Mediviron </strong>Appointment Booking System</a></li>
