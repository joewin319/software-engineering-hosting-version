...
<body style="background-image:url(mgrchange.jpg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="http://alphadevx.infinityfreeapp.com/Admin/mgrmenu.php" class="logo"><img src="../images/cal.png" width="60px" height="60px"><strong> Mediviron </strong>Appointment Booking System</a></li>
			<li><a href="http://alphadevx.infinityfreeapp.com/Admin/mgrmenu.php">Home</a></li>
		</ul>
	</div>
...
<?php
			while($rs1=$results1->fetch_assoc())
			{
				echo "<tr>";
					...
					.'<td><input type="time" name="timeappt[]" id="timeappt" value="'.$rs1["time"].'" readonly></td></tr>';
			}
?>		
			</table>	
...
$conn=mysqli_connect("sql202.epizy.com","epiz_30089770","0ApFzY0pcMj5","epiz_30089770_wt1_database"); 
			if(isset($_POST['submit2']))
		{
			...
			echo "Redirecting.....";
			header( "Refresh:3; url=http://alphadevx.infinityfreeapp.com/Admin/changebookingstatus.php");
